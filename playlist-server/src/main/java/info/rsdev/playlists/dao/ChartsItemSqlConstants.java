...
public final class ChartsItemSqlConstants {
	...
	public static final String GET_NEW_RELEASES_QUERY = String.format("select %s, %s from %s where %s = ? group by %s, %s",
	        ARTIST_COLUMN, TITLE_COLUMN, CHART_ITEM_TABLE, YEAR_COLUMN, ARTIST_COLUMN, TITLE_COLUMN);
